...
$HCSET['API_SECRET_KEY'] = 'v1bd1a65b409a8452c813fac2c8e0a3ce5';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v21414140910&js=false&stage='.$HCSET['stage'];
